...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-9df39454');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-9df39454');}
...
var brandEl=document.querySelector('.rl-brand-9df39454');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
